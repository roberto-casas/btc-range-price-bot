...
async fn backtest_handler(
    ...
    let low_ratio = params.low_ratio.unwrap_or(0.90);
    let high_ratio = params.high_ratio.unwrap_or(1.10);
    let duration = params.duration.unwrap_or(7);
    let yes_price_low = params.yes_price_low.unwrap_or(0.60);
    let yes_price_high = params.yes_price_high.unwrap_or(0.70);
    let history_days = params.history_days.unwrap_or(90);
